...
var client_1 = require("../../apps/backend/src/infra/db/prisma/generated/client");
var adapter_pg_1 = require("@prisma/adapter-pg");
var env_1 = require("../../apps/backend/src/config/env");
var DatabaseService = /** @class */ (function () {
    function DatabaseService() {
        this.isConnected = false;
        var dbUrl = env_1.env.DATABASE_URL;
        if (!dbUrl) {
        ...
        this.prisma = new client_1.PrismaClient({ adapter: adapter });
    }
    ...
    DatabaseService.prototype.isDatabaseConnected = function () {
