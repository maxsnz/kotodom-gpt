...
exports.createUserResource = void 0;
// @ts-expect-error
var prisma_1 = require("@adminjs/prisma");
var prismaClient_1 = require("../../prismaClient");
var components_1 = require("../components");
var createUserResource = function () { return ({
    resource: { model: (0, prisma_1.getModelByName)("User"), client: prismaClient_1.default },
    options: {
        actions: {
            showChats: {
                icon: "MessageSquare",
                actionType: "record",
                component: components_1.default.ShowUserChats,
