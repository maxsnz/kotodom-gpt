...
var getSetting = function (key) { return __awaiter(void 0, void 0, void 0, function () {
    var setting;
...
var setSetting = function (key, value) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, prismaClient_1.default.setting.upsert({
                    where: { id: key },
                    update: { value: value },
